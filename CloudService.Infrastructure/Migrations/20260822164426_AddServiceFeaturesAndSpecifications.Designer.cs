...
namespace CloudService.Infrastructure.Migrations
{
    ...
    [Migration("20260822164426_AddServiceFeaturesAndSpecifications")]
    partial class AddServiceFeaturesAndSpecifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudService.Domain.Entities.CustomerReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CloudService.Domain.Entities.PackageSpecification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PackageSpecifications");
                });
            ...
            modelBuilder.Entity("CloudService.Domain.Entities.ServiceFeature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CloudService.Domain.Entities.PackageSpecification", b =>
                {
                    b.HasOne("CloudService.Domain.Entities.ServicePlan", "ServicePlan")
                        .WithMany("PackageSpecifications")
                        .HasForeignKey("ServicePlanId")
            ...
            modelBuilder.Entity("CloudService.Domain.Entities.ServicePlan", b =>
                {
                    b.Navigation("PackageSpecifications");
