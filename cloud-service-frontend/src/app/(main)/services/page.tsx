...
<Link className="font-body-sm text-body-sm font-semibold text-primary group-hover:text-primary-container flex items-center gap-xs" href="/pricing">Đăng ký Domain <span className="material-symbols-outlined text-[16px]">arrow_forward</span></Link>
</div>
)}
...
<Link className="font-body-sm text-body-sm font-semibold text-primary group-hover:text-primary-container flex items-center gap-xs" href="/pricing">Khám phá Email <span className="material-symbols-outlined text-[16px]">arrow_forward</span></Link>
</div>
)}
...
<Link className="font-body-sm text-body-sm font-semibold text-primary group-hover:text-primary-container flex items-center gap-xs" href="/pricing">Xem SSL <span className="material-symbols-outlined text-[16px]">arrow_forward</span></Link>
</div>
...
<Link className="font-body-sm text-body-sm font-semibold text-primary group-hover:text-primary-container flex items-center gap-xs" href="/pricing">Khám phá Security <span className="material-symbols-outlined text-[16px]">arrow_forward</span></Link>
</div>
</>
)}
</div>
