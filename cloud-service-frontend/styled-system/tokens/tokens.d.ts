/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `easings.${EasingToken}` | `durations.${DurationToken}` | `letterSpacings.${LetterSpacingToken}` | `animations.${AnimationToken}` | `colors.${ColorToken}` | `spacing.${SpacingToken}` | `sizes.${SizeToken}` | `radii.${RadiusToken}` | `fonts.${FontToken}` | `fontSizes.${FontSizeToken}` | `lineHeights.${LineHeightToken}` | `fontWeights.${FontWeightToken}` | `shadows.${ShadowToken}` | `blurs.${BlurToken}` | `breakpoints.${BreakpointToken}`
